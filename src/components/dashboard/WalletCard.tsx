  ...
  return (
    <div className="relative">
      ...
      <motion.div 
        ...
        className="bg-gradient-to-br from-[#86d2e5] to-[#006778] rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-12 flex flex-col justify-between min-h-[260px] md:min-h-[360px] shadow-2xl relative overflow-hidden group premium-glow glow-pulse cursor-pointer transition-all"
      ...
      >
        ...
        <div className="relative z-10 mt-8 md:mt-12 flex justify-between items-end">
          <div className="flex flex-col">
            <span className="text-white/60 text-[9px] md:text-[10px] font-black uppercase tracking-widest mb-1">
              {lang === "id" ? "DOMPET TERSINKRON" : "SYNCED WALLETS"}
            </span>
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            >
               <div className="flex justify-between items-center mb-8 px-2">
                  <div>
                    <h3 className="text-xl font-black font-headline tracking-tighter uppercase">{lang === "id" ? "Pilih Dompet" : "Choose Wallet"}</h3>
                    <p className="text-[9px] text-[#899295] font-black uppercase tracking-[0.2em]">{lang === "id" ? "MANAJEMEN ASET" : "ASSET MANAGEMENT"}</p>
                  </div>
               ...
               <div className="space-y-3 pb-4">
                  ...
                  <button 
                    ...
                    className={`w-full flex items-center justify-between p-5 rounded-2xl transition-all border ${selectedWalletId === "all" ? "bg-gradient-to-r from-[#86d2e5]/20 to-[#006778]/10 border-[#86d2e5]/30 shadow-lg" : "bg-white/5 border-transparent hover:bg-white/10"}`}
                  >
                  ...
                  <div className="max-h-[300px] overflow-y-auto space-y-3 pr-2 scrollbar-hide">
                    {wallets.map((w) => (
                      <button 
                        ...
                        className={`w-full flex items-center justify-between p-5 rounded-2xl transition-all border ${selectedWalletId === w.id ? "bg-white/10 border-[#86d2e5]/30 shadow-lg" : "bg-white/5 border-transparent hover:bg-white/10"}`}
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-left">
                            <p className={`text-sm font-black ${selectedWalletId === w.id ? "text-white" : "text-[#899295]"}`}>{w.name}</p>
